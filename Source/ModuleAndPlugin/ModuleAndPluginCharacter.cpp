...
#include "MyNBCLog/PluginTestActor.h"
...
void AModuleAndPluginCharacter::BeginPlay()
{
	...
	//스폰시 충돌이 발생하면 근처 빈 공간에 스폰합니다.
	spawnParams.SpawnCollisionHandlingOverride = ESpawnActorCollisionHandlingMethod::AdjustIfPossibleButAlwaysSpawn;
	GetWorld()->SpawnActor<APluginTestActor>(APluginTestActor::StaticClass(),GetActorLocation()+FVector(300.f,0.f,-50.f),GetActorRotation(),spawnParams);
